...
int main() 
{
    ...
    int taille = 999; 
    double* temperature_variations = linspace(0.01,10,taille); 
    ...
    FILE *energie_file = fopen("energie_rechauffement_L40.txt", "w"); 
    ...
    const int nombre_cycles_pre = 120000 + taille + 50000; //1 cycle = 128 tentatives, réussies ou non
    const int fin_phase2 = 120000+taille; 
