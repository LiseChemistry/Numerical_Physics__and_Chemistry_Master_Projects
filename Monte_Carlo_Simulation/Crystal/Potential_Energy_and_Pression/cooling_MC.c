...
#define L  10               // Taille de la boîte
...
int main() 
{
    ...
    int taille = 999; 
    double* temperature_variations = arange(10,0,-0.01);
    ...
    FILE *energie_file = fopen("energie_refroidissement_L10.txt", "w"); 
    ...
    const int nombre_cycles_pre = 10000 + taille + 25000; //1 cycle = 128 tentatives, réussies ou non
    const int fin_phase2 = 10000+taille; 
    ...
    for (int cycle=0 ; cycle<nombre_cycles_pre; cycle++){


            if (cycle <= 10000){

                printf("phase 1, cycle : %d\n", cycle); 
                ...
                for (int tentativou=0; tentativou < nbx_particules ; tentativou++){
                    ...
                    double proba_finale=calcul_boltzmann(tab_particules, tab_particules_temporaire,index_modidi, temperature_variations[0]); 
                    //printf("%f\n", proba_finale);
            ...
            } else if (40000 < cycle && cycle <= fin_phase2){

                printf("phase 2, cycle : %d\n", cycle); 
                ...
                for (int tentativou=0; tentativou < nbx_particules ; tentativou++){
                    ...
                    double proba_finale=calcul_boltzmann(tab_particules, tab_particules_temporaire,index_modidi, temperature_variations[cycle_externe]); 
